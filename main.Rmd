...
knitr::opts_chunk$set(fig.width=8, fig.height=6, fig.align = "center", 
                      echo=FALSE, warning=FALSE, include=TRUE, tidy = TRUE, message=FALSE)
```
...
annotate_figure(ggarrange(figureM, figureQ, 
                     ncol = 1, nrow = 2), 
                bottom = 
                  text_grob("Figure 5: Genus distribution of Planctomycetes across samples",
                            face = "bold", size = 12))
```
