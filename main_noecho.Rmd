...
annotate_figure(ggarrange(figureM, figureQ, ncol = 1, nrow = 2, 
                                     labels = c("(a)", "(b)")),
                bottom = text_grob("Figure 6: Abundance of OTUs/ASVs within Planctomyces genus across depth", face = "bold", size = 12))
```
...
annotate_figure(ggarrange(figureM, figureQ, ncol = 1, nrow = 2, 
                                     labels = c("(a)", "(b)")),
                bottom = text_grob("Figure 7: Abundance of OTUs/ASVs within Planctomyces genus across oxygen concentration", 
                                   face = "bold", size = 12))
```
